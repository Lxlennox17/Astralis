package net.lxlennox.astralis.worldgen.feature.custom;
...
public class HugeForestStoneFeature extends Feature<SingleStateFeatureConfig> {
    public HugeForestStoneFeature(Codec<SingleStateFeatureConfig> codec) {
        super(codec);
    }
