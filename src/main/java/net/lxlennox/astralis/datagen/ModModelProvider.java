...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        //Non-BLock Blocks
        var moonveilFamily = new BlockFamily.Builder(ModBlocks.MOONVEIL_PLANKS)
                ...
                .sign(ModBlocks.MOONVEIL_SIGN,ModBlocks.MOONVEIL_HANGING_SIGN)
                ...
                .build();
        blockStateModelGenerator.registerCubeAllModelTexturePool(moonveilFamily.getBaseBlock())
                .family(moonveilFamily);
